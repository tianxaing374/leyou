...
public class SmsUtils {
    ...
    private static final Long SMS_MIN_INTERVAL_MILLS = 60000L;
...
//    static final String accessKeySecret = "aySR4oBRliswLp87rF9gQyy1Izz4MQ";
    ...
    public SendSmsResponse sendSms(String phoneNumber,String signName,String templateCode,String templateParam) {
        ...
        log.info("lastTime from redis:{}",lastTime);
        if(StringUtils.isNotBlank(lastTime)){
            log.info("[短信服务]发送短信的频率过快，被阻止。");
            return null;
        }
        ...
        try {
            ...
            //发送短信后
            stringRedisTemplate.opsForValue().set(key,String.valueOf(System.currentTimeMillis()),SMS_MIN_INTERVAL_MILLS, TimeUnit.MILLISECONDS);
        }
    }
